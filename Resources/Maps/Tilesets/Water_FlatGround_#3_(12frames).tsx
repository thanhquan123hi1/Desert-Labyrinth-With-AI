...
<tileset version="1.10" tiledversion="1.11.2" name="Water_FlatGround_#3_(12frames)" tilewidth="64" tileheight="64" tilecount="12" columns="12">
 <image source="../Image/Water_FlatGround_#3_(12frames).png" width="768" height="64"/>
 <tile id="0">
  <animation>

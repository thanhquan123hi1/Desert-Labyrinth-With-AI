...
<tileset version="1.10" tiledversion="1.11.2" name="Rocks_04" tilewidth="128" tileheight="128" tilecount="8" columns="8" tilerendersize="grid">
 <image source="../../Animation/Rocks_04.png" width="1024" height="128"/>
 <tile id="0">
  <animation>
